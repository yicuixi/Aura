...
**评估时间**: 2026-04-08T00:03:36.125494
**测试用例数**: 3
**通过/失败**: 0 / 3
...
| 指标 | 值 | 说明 |
|------|-----|------|
| **工具调用准确率** | 33.33% | 正确判断是否需要工具 |
| **任务成功率** | 33.33% | 成功完成任务的比例 |
| **平均响应时间** | 90842ms | 从输入到输出的时间 |
...
| 维度 | 得分 | 通过/总数 | 平均响应时间 |
|------|------|-----------|------------|
| 逻辑推理 | 100.00% `██████████` | 1/1 | 98138ms |
| 知识检索 | 0.00% `░░░░░░░░░░` | 0/2 | 87194ms |
