...
**评估时间**: 2026-04-07T23:27:11.614832
**测试用例数**: 3
**通过/失败**: 0 / 3
...
- **任务完成**: ❌ 失败
- **响应时间**: 2095ms
- **回答预览**: 抱歉，出错了: HTTPConnectionPool(host='localhost', port=11434): Max retries exceeded with url: /api/genera...
...
| 维度 | 得分 | 通过/总数 | 平均响应时间 |
|------|------|-----------|------------|
| 逻辑推理 | 0.00% `░░░░░░░░░░` | 0/1 | 2066ms |
| 知识检索 | 0.00% `░░░░░░░░░░` | 0/2 | 2072ms |
